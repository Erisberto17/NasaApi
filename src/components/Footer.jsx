        ...
        ">
            ...
            ">
                ...
                <ul className="text-white
                    sm:w-[100%] sm:text-center sm:mt-5 sm:text-[1rem] lg:w-[50%]
                ">
                    <li>
